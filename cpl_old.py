...
stdate  = '2017-07-16T10:00:00.000'# start date iso format T10:00:00.000 2017-07-16T11:00:00.000
enddate = '2017-07-17T03:00:00.000'# end date iso format 2017-07-17T03:00:00.000
dirname = 'test_cpl'
c_ur    = 12 #This feels wrong
...
circ_m  = 'denv_a' # circulation method
...
for i in range(k):
    for t in range(nt):
        tskin_clst[t,i]=np.mean(fp['tskin'][t,:,:][fp['cluster'][t,:,:]==i])
        ...
        for k1 in range(k):
            for k2 in range(k1+1,k):
                ...
                dThlm,dRtm,wz_s[:,i,:],u_r[i,:],u_rz[:,i],z_circh[i],z_circl[i],dzic[i],u_r0[i,:],dvpt[i] = \
                    ...
                    cd_=cdirect[k1,k2,:],u_=um,l=l_het,pa=data2,urpv=urpvin)
